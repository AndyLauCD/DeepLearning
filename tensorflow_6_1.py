...
def inference(images):
    ...
    with tf.name_scope('conv1') as scope:
        ...
        lrn1 = tf.nn.lrn(conv1, 4, 1.0, 0.001/9, 0.75, 'lrn1')
        pool1 = tf.nn.max_pool(
            lrn1, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1],
    ...
    with tf.name_scope('conv2') as scope:
        ...
        lrn2 = tf.nn.lrn(conv2, 4, 1.0, 0.001/9, 0.75, 'lrn2')
    ...
    pool5 = tf.nn.max_pool(
        conv5, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1],
