# -*- coding: utf-8 -*-
# @StartTime : 2018/1/22 15:28
# @EndTime : 2018/1/22 15:28
# @Author  : Andy
# @Site    : 
# @File    : tensorflow_6_2.py
# @Software: PyCharm
...
def conv_op(input_op, name, kh, kw, n_out, dh, dw, p):
    """
    :param input_op: input tensor such as pool1 layer or image layer
    :param name: layer name
    :param kh: kernel height
    :param kw: kernel width
    :param n_out: numbers of output channels
    ...
    with tf.name_scope(name) as scope:
        ...
        conv = tf.nn.conv2d(input_op, kernel, [1, dh, dw, 1], 'SAME')
